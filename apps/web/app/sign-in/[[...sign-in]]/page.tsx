// Validate Clerk key before importing
...
const getSignInComponent = () => {
  ...
  try {
    return require("@clerk/nextjs").SignIn;
  } catch {
    return null;
  }
};
...
export default function Page() {
  const SignIn = getSignInComponent();
    ...
    return (
      <div className="flex min-h-[60dvh] items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Please configure Clerk authentication to use this page.</p>
        </div>
      </div>
    );
  }
